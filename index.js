...
*/
const R E V = '💔 R E V 💔'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] R E V ready scan now!`);
});
...
conn.on('message-new', async(m) =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Nomor: [ ${pushname} ] => ${text}`);
   //GroupsA187ID
...
conn.sendMessage(id, ' _Salam Juga, Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Syalom Sahabat Terkasih 😇 , ada yang bisa saya bantu? Ketik *#menu* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'syalom'){
conn.sendMessage(id, ' _Syalom Sahabat Terkasih 😇 , ada yang bisa saya bantu? Ketik *#menu* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' *Creator 💔 R E V 💔 wa.me/+6283164445159* ' ,MessageType.text);
}
else if (text == 'Pagi'){
